import { LayoutDashboard, ArrowLeftRight, Target, Repeat, BarChart3, PiggyBank, Gift, Wallet, Trophy, CreditCard, PieChart } from "lucide-react";
...
export default function BottomNav({ activePage, onNavigate }) {
  return (
    <nav className="md:hidden fixed bottom-0 inset-x-0 z-40 bg-white/50 dark:bg-gray-900/50 backdrop-blur-2xl backdrop-saturate-150 border-t border-white/60 dark:border-gray-800/60 pb-[env(safe-area-inset-bottom)]">
